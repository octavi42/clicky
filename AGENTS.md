...
| `SimulationControlPanelView.swift` | ~513 | Presenter-only "Clicky Memory Demo" cockpit. Live Demo State tiles, demo profile chips, and reset are wired to `SimulationDemoEngine`; the four feature demo cards, Ask Clicky quick actions, and proof panel are still placeholders. |
